<?php
// app/Livewire/Layouts/MaintenanceHistoryDetail.php
...
class MaintenanceHistoryDetail extends Component
{
    ...
    // This simulates the data you'd get *after* joining all tables
    protected $dummyHistoryDetails = [
        // 1: Completed Item (This is a "Log")
        1 => [
            'request_id' => 1,
            'lease_id' => 101,
            'status' => 'Completed',
        ...
        // 2: Ongoing Item (This is a "Request")
        2 => [
            'request_id' => 2,
            'lease_id' => 102,
            'status' => 'Ongoing',
            ...
            // Maintenance Log data (null for ongoing)
            'completion_date' => null,
            'cost' => null
        ],
        // 3: Completed Item (This is a "Log")
        3 => [
            'request_id' => 3,
            'lease_id' => 103,
            'status' => 'Completed',
        ...
        // 4: Pending Item (This is a "Request")
        4 => [
            'request_id' => 4,
            'lease_id' => 104,
            'status' => 'Pending',
            ...
            // Maintenance Log data (null for pending)
            'completion_date' => null,
            'cost' => null
        ],
        // 5: Pending Item (This is a "Request")
        5 => [
            'request_id' => 5,
            'lease_id' => 105,
            'status' => 'Pending',
    ...
    public function markCompleted(): void
    {
        if ($this->currentHistoryId) {
            ...
            // Simulate adding log data
            $this->currentHistoryItem['completion_date'] = now()->format('Y-m-d');
            $this->currentHistoryItem['cost'] = 1000.00; // Default cost
    ...
    {
        return view('livewire.layouts.maintenance-history-detail');
    }
}
