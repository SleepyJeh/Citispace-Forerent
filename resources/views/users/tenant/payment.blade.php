            ...
            <div id="pm-container" class="w-full min-h-full rounded-tl-4xl bg-[#F4F7FC] flex flex-col px-4 md:px-8 lg:px-18 pt-9 pb-16 gap-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div class="flex flex-col">
                        <span id="main-header" class="header-title text-2xl md:text-3xl text-blue-900 font-bold">PAYMENT DOCUMENTATION</span>
                        <span class="sub-header text-sm md:text-base text-gray-600">Access payment history and document new receipts</span>
                    </div>
                </div>
