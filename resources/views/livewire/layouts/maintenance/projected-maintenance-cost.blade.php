...
<div class="space-y-6">
    ...
    {{-- 2. GRAPH SECTION (Real Data from DB) --}}
    <div class="bg-white rounded-[30px] shadow-sm p-8">
        <div class="mb-8">
            <h3 class="text-2xl font-bold text-[#070642]">Projected Maintenance Cost</h3>
        </div>

        {{-- Chart Container --}}
        <div class="w-full h-96 relative" wire:ignore>
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            ...
                            ticks: { font: { family: "'Open Sans', sans-serif" }, color: '#9CA3AF' },
