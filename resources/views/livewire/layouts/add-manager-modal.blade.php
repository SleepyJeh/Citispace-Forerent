<div>
    ...
    >
        <div
            class="relative w-full max-w-3xl bg-gray-50 rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col"
            @click.stop
        >
            <!-- Modal Header -->
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="relative">
                                    <input
                                        ...
                                        type="text"
                                        id="phone-{{ $modalId }}"
                                        class="block pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#0030C5] peer pr-2.5 pl-2.5 peer-focus:pl-16 peer-[:not(:placeholder-shown)]:pl-16"
                                        placeholder=" "
                                    />
                                    <div class="absolute top-4 left-0 px-3 flex items-center space-x-2 pointer-events-none opacity-0 transition-opacity duration-300 peer-focus:opacity-100 peer-[:not(:placeholder-shown)]:opacity-100">
